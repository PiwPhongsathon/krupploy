...
<body>
        ...
        <div class="navheader">
            ...
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content">
                    ...
                    <a href="./program.php">
                        <img src="../img/program.png" alt="Program Icon" width="20" height="20">โปรแกรมการสอน
                    </a>
                    <a href="javascript:void(0);" onclick="openModal()">
                        <img src="../img/setting.png" alt="Settings Icon" width="25" height="25">ตั้งค่า
                    </a>
                    <a href="../logout.php">
                        <img src="../img/logout.png" alt="Logout Icon">ออกจากระบบ
                    </a>
                </div>
            </div>
        </div>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form action="../teacher/update_user.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="bank_slip_image">อัปโหลดสลิปธนาคาร:</label>
                    <input type="file" id="bank_slip_image" name="bank_slip_image" accept="image/*">
                </div>
